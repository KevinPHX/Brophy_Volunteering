...
var appRoutes = [
    ...
    { path: 'update', component: __WEBPACK_IMPORTED_MODULE_21__components_update_update_component__["a" /* UpdateComponent */] },
    ...
    { path: 'request', component: __WEBPACK_IMPORTED_MODULE_24__components_request_request_component__["a" /* RequestComponent */] },
    { path: 'myacceptedrequests', component: __WEBPACK_IMPORTED_MODULE_27__components_myacceptedrequests_myacceptedrequests_component__["a" /* MyacceptedrequestsComponent */] },
    { path: 'myrequest', component: __WEBPACK_IMPORTED_MODULE_25__components_myrequest_myrequest_component__["a" /* MyrequestComponent */] },
    { path: 'mypastrequests', component: __WEBPACK_IMPORTED_MODULE_26__components_mypastrequests_mypastrequests_component__["a" /* MypastrequestsComponent */] },
    { path: 'editrequest', component: __WEBPACK_IMPORTED_MODULE_28__components_editrequest_editrequest_component__["a" /* EditrequestComponent */] },
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.acceptHelp = function (username) {
        this.dataService.acceptHelp(username).subscribe(function (data) {
...
var EditrequestComponent = /** @class */ (function () {
    ...
    EditrequestComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.myRequest().subscribe(function (request) {
            _this.subject = request[0].subject;
            _this.topic = request[0].topic;
            _this.addinfo = request[0].addinfo;
        }, function (err) {
            console.log(err);
            return false;
        });
    ...
    EditrequestComponent.prototype.editRequest = function () {
        ...
        this.dataService.editRequest(user).subscribe(function (data) {
        ...
        this.authService.findUsers().subscribe(function (Data) {
            _this.authService.forgotUser(user).subscribe(function (data) {
                if (data) {
                    ...
                    console.log(user.email);
                    _this.flashMessage.show("Please try again", { cssClass: 'alert-danger', timeout: 3000 });
                    return false;
                }
            });
        });
...
var MyrequestComponent = /** @class */ (function () {
    ...
    MyrequestComponent.prototype.cancelHelp = function () {
        this.dataService.cancelHelp().subscribe(function (data) {
...
module.exports = "<h2 class='page-header'>Request</h2>\n<form (submit)='requestHelp()'>\n  <div class='form-group'>\n    <h4>Subject</h4>\n    <input type='text' class='form-control' [(ngModel)]='subject' name='subject'>\n    <h4>Topic</h4>\n    <input type='text' class='form-control' [(ngModel)]='topic' name='topic'>\n    <h4>Additional Information</h4>\n    <input type='text' class='form-control' [(ngModel)]='addinfo' name='addinfo'>\n  </div>\n  <input type='submit' class='btn btn-primary' (click) = \"requestHelp()\" value='Submit' [routerLink]=\"['/dashboard']\"><a class='btn btn-default' [routerLink]=\"['/dashboard']\" value = \"Cancel\">Cancel</a>\n</form>\n"
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.acceptHelp = function (username) {
        var _this = this;
        return this.authService.getProfile().flatMap(function (profile) {
            _this.user = profile.user;
            _this.email = profile.user.email;
            ...
            var headers = new Headers();
            headers.append("Content-Type", 'application/json');
            return _this.http.post('https://localhost:3000/users/accept/' + username + "/" + _this.email, { headers: headers })
                .map(function (res) { return res.json(); });
        });
    };
    DataService.prototype.cancelHelp = function () {
        var _this = this;
        return this.authService.getProfile().flatMap(function (profile) {
            _this.user = profile.user;
            _this.username = profile.user.username;
            ...
            var headers = new Headers();
            headers.append("Content-Type", 'application/json');
            return _this.http.post('https://localhost:3000/users/cancel/' + _this.username, { headers: headers })
                .map(function (res) { return res.json(); });
        });
    };
    DataService.prototype.editRequest = function (user) {
        var _this = this;
        return this.authService.getProfile().flatMap(function (profile) {
            _this.user = profile.user;
            _this.username = profile.user.username;
            ...
            var headers = new Headers();
            headers.append("Content-Type", 'application/json');
            return _this.http.post('https://localhost:3000/users/editrequest/' + _this.username, user, { headers: headers })
                .map(function (res) { return res.json(); });
        });
    };
